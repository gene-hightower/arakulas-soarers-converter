...
#define ATCMD_RESET \
  0xff  // reset request; ACK + BATOK after some time is expected
...
// The above 3 are followed by list of scan codes and an unused scan code to
// end the list; the keyboard is expected to answer with KBDM_ACK to each
...
#define ATCMD_DISABLE \
  0xf5  // Reset Keyboard to Default State and Disable scanning
#define ATCMD_ENABLE 0xf4   // (Re-)Enable Scanning after it has been disabled
#define ATCMD_SETRATE 0xf3  // Set Typematic rate/delay
#define ATCMD_READID \
  0xf2  // Keyboard is expected to respond with its 2-byte ID (ACK before 1st
        // byte)
#define ATCMD_SCANSET \
  0xf0  // Set Scancode Set (<- ACK/Err -> [new set(1|2|3) <- ACK/Err | 0 <-
        // ACK+current|Err])
#define ATCMD_ECHO 0xee  // Send Echo (<- ECHO)
#define ATCMD_SETLEDS \
  0xed  // Set LED State (<- ACK -> Caps:2+Num:1+Scroll:0 <- ACK)
...
#define KBDID_TERM122 \
  0xbfbf  // 122-key IBM 1390876 without jumpers (can be reconfigured!)
...
const uint8_t PROGMEM kbd_ttbl_set2[0x85] = {
    ...
    KEY_TAB,
    KEY_BACK_QUOTE,
    KEY_PAD_EQUALS,  // 0C..0F
    KEY_F14,
    KEY_LALT,
    KEY_LSHIFT,
    KEY_INTERNATIONAL_2,  // 10..13
    KEY_LCTRL,
    KEY_Q,
    KEY_1,
    KEY_FAKE_01,  // 14..17
...
const uint8_t PROGMEM kbd_ttbl_set2ex[0x7f] = {
    ...
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 00..03
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 04..07
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 08..0B
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 0C..0F
    KEY_MEDIA_WWW_SEARCH,
    KEY_RALT,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 10..13
    KEY_RCTRL,
    KEY_MEDIA_PREV_TRACK,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 14..17
    KEY_MEDIA_WWW_FAVORITES,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 18..1B
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_LGUI,  // 1C..1F
    ...
    KEY_UNASSIGNED,
    KEY_MEDIA_WWW_HOME,
    KEY_MEDIA_STOP,  // 38..3B
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_SYSTEM_SLEEP,  // 3C..3F
    KEY_MEDIA_MY_COMPUTER,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 40..43
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 44..47
    KEY_MEDIA_MAIL,
    KEY_UNASSIGNED,
    KEY_PAD_SLASH,
    KEY_UNASSIGNED,  // 48..4B
    KEY_UNASSIGNED,
    KEY_MEDIA_NEXT_TRACK,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 4C..4F
    KEY_MEDIA_MEDIA_SELECT,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 50..53
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 54..57
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_PAD_ENTER,
    KEY_UNASSIGNED,  // 58..5B
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_SYSTEM_WAKE,
    KEY_UNASSIGNED,  // 5C..5F
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 60..63
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 64..67
    KEY_UNASSIGNED,
    KEY_END,
    KEY_UNASSIGNED,
    KEY_LEFT,  // 68..6B
    ...
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 6C..6F
    KEY_INSERT,
    KEY_DELETE,
    KEY_DOWN,
    KEY_UNASSIGNED,  // 70..73
    KEY_RIGHT,
    KEY_UP,
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,  // 74..77
    KEY_UNASSIGNED,
    KEY_UNASSIGNED,
    KEY_PAGE_DOWN,
    KEY_UNASSIGNED,  // 78..7B
    KEY_PRINTSCREEN,
    KEY_PAGE_UP,
    KEY_PAUSE  // 7C..7E
};
